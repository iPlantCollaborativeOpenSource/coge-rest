# This Makefile is for the CoGe::REST extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/CoGe/REST.pm]
#     AUTHOR => q[Dennis Roberts <dennis@iplantcollaborative.org>]
#     BUILD_REQUIRES => {  }
#     NAME => q[CoGe::REST]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/CoGe/REST.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/CoGe/REST.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/CoGe
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/CoGe
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/CoGe/REST.pm $(INST_MAN3DIR)/CoGe::REST.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               CoGe-REST' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           TODO: describe the package in general here.' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Dennis Roberts <dennis@iplantcollaborative.org>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>TODO: describe the package in general here.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Dennis Roberts &lt;dennis@iplantcollaborative.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
